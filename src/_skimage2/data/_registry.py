...
# TEMPORARY validation config: points at a personal GitLab fork/package while the
# GitLab Generic Package Registry CDN migration is validated on this branch.
# Before merging, repoint at the production package:
#   _GITLAB_DATA_PROJECT = "scikit-image%2Fdata"
#   _GITLAB_DATA_PACKAGE = "scikit-image-data"
_GITLAB_DATA_PROJECT = "stevesilvester1073%2Fdata"
_GITLAB_DATA_PACKAGE = "scikit-image-data-steve-test"
_GITLAB_DATA_VERSION = "v1"
_GITLAB_DATA_BASE_URL = (
    f"https://gitlab.com/api/v4/projects/{_GITLAB_DATA_PROJECT}"
    f"/packages/generic/{_GITLAB_DATA_PACKAGE}/{_GITLAB_DATA_VERSION}"
)
...
registry_urls = {
    "data/brain.tiff": f"{_GITLAB_DATA_BASE_URL}/brain.tiff",
    "data/cells3d.tif": f"{_GITLAB_DATA_BASE_URL}/cells3d.tif",
    "data/palisades_of_vogt.tif": f"{_GITLAB_DATA_BASE_URL}/palisades_of_vogt.tif",
    "data/eagle.png": f"{_GITLAB_DATA_BASE_URL}/eagle.png",
    "data/kidney.tif": f"{_GITLAB_DATA_BASE_URL}/kidney.tif",
    "data/lily.tif": f"{_GITLAB_DATA_BASE_URL}/lily.tif",
    "data/mitosis.tif": f"{_GITLAB_DATA_BASE_URL}/mitosis.tif",
    "data/rank_filters_tests_3d.npz": f"{_GITLAB_DATA_BASE_URL}/rank_filters_tests_3d.npz",
    "data/skin.jpg": f"{_GITLAB_DATA_BASE_URL}/skin.jpg",
    "data/pivchallenge-B-B001_1.tif": f"{_GITLAB_DATA_BASE_URL}/pivchallenge-B-B001_1.tif",
    "data/pivchallenge-B-B001_2.tif": f"{_GITLAB_DATA_BASE_URL}/pivchallenge-B-B001_2.tif",
    "data/protein_transport.tif": f"{_GITLAB_DATA_BASE_URL}/protein_transport.tif",
    "data/solidification.tif": f"{_GITLAB_DATA_BASE_URL}/solidification.tif",
    "restoration/astronaut_rl.npy": f"{_GITLAB_DATA_BASE_URL}/astronaut_rl.npy",
    "data/gray_morph_output.npz": f"{_GITLAB_DATA_BASE_URL}/gray_morph_output.npz",
    "data/_blobs_3d_fiji_skeleton.tif": f"{_GITLAB_DATA_BASE_URL}/_blobs_3d_fiji_skeleton.tif",
    "data/astronaut.png": f"{_GITLAB_DATA_BASE_URL}/astronaut.png",
    "data/astronaut_GRAY_hog_L1.npy": f"{_GITLAB_DATA_BASE_URL}/astronaut_GRAY_hog_L1.npy",
    "data/astronaut_GRAY_hog_L2-Hys.npy": f"{_GITLAB_DATA_BASE_URL}/astronaut_GRAY_hog_L2-Hys.npy",
    "data/brick.png": f"{_GITLAB_DATA_BASE_URL}/brick.png",
    "data/bw_text.png": f"{_GITLAB_DATA_BASE_URL}/bw_text.png",
    "data/bw_text_skeleton.npy": f"{_GITLAB_DATA_BASE_URL}/bw_text_skeleton.npy",
    "data/camera.png": f"{_GITLAB_DATA_BASE_URL}/camera.png",
    "data/cell.png": f"{_GITLAB_DATA_BASE_URL}/cell.png",
    "data/checker_bilevel.png": f"{_GITLAB_DATA_BASE_URL}/checker_bilevel.png",
    "data/chelsea.png": f"{_GITLAB_DATA_BASE_URL}/chelsea.png",
    "data/chessboard_GRAY.png": f"{_GITLAB_DATA_BASE_URL}/chessboard_GRAY.png",
    "data/chessboard_GRAY_U16.tif": f"{_GITLAB_DATA_BASE_URL}/chessboard_GRAY_U16.tif",
    "data/chessboard_GRAY_U16B.tif": f"{_GITLAB_DATA_BASE_URL}/chessboard_GRAY_U16B.tif",
    "data/chessboard_GRAY_U8.npy": f"{_GITLAB_DATA_BASE_URL}/chessboard_GRAY_U8.npy",
    "data/chessboard_RGB.png": f"{_GITLAB_DATA_BASE_URL}/chessboard_RGB.png",
    "data/clock_motion.png": f"{_GITLAB_DATA_BASE_URL}/clock_motion.png",
    "data/coffee.png": f"{_GITLAB_DATA_BASE_URL}/coffee.png",
    "data/coins.png": f"{_GITLAB_DATA_BASE_URL}/coins.png",
    "data/color.png": f"{_GITLAB_DATA_BASE_URL}/color.png",
    "data/diamond-matlab-output.npz": f"{_GITLAB_DATA_BASE_URL}/diamond-matlab-output.npz",
    "data/disk-matlab-output.npz": f"{_GITLAB_DATA_BASE_URL}/disk-matlab-output.npz",
    "data/foo3x5x4indexed.png": f"{_GITLAB_DATA_BASE_URL}/foo3x5x4indexed.png",
    "data/grass.png": f"{_GITLAB_DATA_BASE_URL}/grass.png",
    "data/gravel.png": f"{_GITLAB_DATA_BASE_URL}/gravel.png",
    "data/green_palette.png": f"{_GITLAB_DATA_BASE_URL}/green_palette.png",
    "data/horse.png": f"{_GITLAB_DATA_BASE_URL}/horse.png",
    "data/hubble_deep_field.jpg": f"{_GITLAB_DATA_BASE_URL}/hubble_deep_field.jpg",
    "data/ihc.png": f"{_GITLAB_DATA_BASE_URL}/ihc.png",
    "data/lbpcascade_frontalface_opencv.xml": f"{_GITLAB_DATA_BASE_URL}/lbpcascade_frontalface_opencv.xml",
    "data/lfw_subset.npy": f"{_GITLAB_DATA_BASE_URL}/lfw_subset.npy",
    "data/logo.png": f"{_GITLAB_DATA_BASE_URL}/logo.png",
    "data/microaneurysms.png": f"{_GITLAB_DATA_BASE_URL}/microaneurysms.png",
    "data/moon.png": f"{_GITLAB_DATA_BASE_URL}/moon.png",
    "data/motorcycle_disp.npz": f"{_GITLAB_DATA_BASE_URL}/motorcycle_disp.npz",
    "data/motorcycle_left.png": f"{_GITLAB_DATA_BASE_URL}/motorcycle_left.png",
    "data/motorcycle_right.png": f"{_GITLAB_DATA_BASE_URL}/motorcycle_right.png",
    "data/mssim_matlab_output.npz": f"{_GITLAB_DATA_BASE_URL}/mssim_matlab_output.npz",
    "data/multipage.tif": f"{_GITLAB_DATA_BASE_URL}/multipage.tif",
    "data/multipage_rgb.tif": f"{_GITLAB_DATA_BASE_URL}/multipage_rgb.tif",
    "data/no_time_for_that_tiny.gif": f"{_GITLAB_DATA_BASE_URL}/no_time_for_that_tiny.gif",
    "data/page.png": f"{_GITLAB_DATA_BASE_URL}/page.png",
    "data/palette_color.png": f"{_GITLAB_DATA_BASE_URL}/palette_color.png",
    "data/palette_gray.png": f"{_GITLAB_DATA_BASE_URL}/palette_gray.png",
    "data/phantom.png": f"{_GITLAB_DATA_BASE_URL}/phantom.png",
    "data/rank_filter_tests.npz": f"{_GITLAB_DATA_BASE_URL}/rank_filter_tests.npz",
    "data/retina.jpg": f"{_GITLAB_DATA_BASE_URL}/retina.jpg",
    "data/rocket.jpg": f"{_GITLAB_DATA_BASE_URL}/rocket.jpg",
    "data/text.png": f"{_GITLAB_DATA_BASE_URL}/text.png",
    "data/truncated.jpg": f"{_GITLAB_DATA_BASE_URL}/truncated.jpg",
}
