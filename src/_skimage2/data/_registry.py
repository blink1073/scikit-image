...
_CDN_HOSTED_KEYS = [
    "data/brain.tiff",
    "data/cells3d.tif",
    "data/palisades_of_vogt.tif",
    "data/eagle.png",
    "data/kidney.tif",
    "data/lily.tif",
    "data/mitosis.tif",
    "data/rank_filters_tests_3d.npz",
    "data/skin.jpg",
    "data/pivchallenge-B-B001_1.tif",
    "data/pivchallenge-B-B001_2.tif",
    "data/protein_transport.tif",
    "data/solidification.tif",
    "restoration/astronaut_rl.npy",
    "data/gray_morph_output.npz",
    "data/_blobs_3d_fiji_skeleton.tif",
    "data/astronaut.png",
    "data/astronaut_GRAY_hog_L1.npy",
    "data/astronaut_GRAY_hog_L2-Hys.npy",
    "data/brick.png",
    "data/bw_text.png",
    "data/bw_text_skeleton.npy",
    "data/camera.png",
    "data/cell.png",
    "data/checker_bilevel.png",
    "data/chelsea.png",
    "data/chessboard_GRAY.png",
    "data/chessboard_GRAY_U16.tif",
    "data/chessboard_GRAY_U16B.tif",
    "data/chessboard_GRAY_U8.npy",
    "data/chessboard_RGB.png",
    "data/clock_motion.png",
    "data/coffee.png",
    "data/coins.png",
    "data/color.png",
    "data/diamond-matlab-output.npz",
    "data/disk-matlab-output.npz",
    "data/foo3x5x4indexed.png",
    "data/grass.png",
    "data/gravel.png",
    "data/green_palette.png",
    "data/horse.png",
    "data/hubble_deep_field.jpg",
    "data/ihc.png",
    "data/lbpcascade_frontalface_opencv.xml",
    "data/lfw_subset.npy",
    "data/logo.png",
    "data/microaneurysms.png",
    "data/moon.png",
    "data/motorcycle_disp.npz",
    "data/motorcycle_left.png",
    "data/motorcycle_right.png",
    "data/mssim_matlab_output.npz",
    "data/multipage.tif",
    "data/multipage_rgb.tif",
    "data/no_time_for_that_tiny.gif",
    "data/page.png",
    "data/palette_color.png",
    "data/palette_gray.png",
    "data/phantom.png",
    "data/rank_filter_tests.npz",
    "data/retina.jpg",
    "data/rocket.jpg",
    "data/text.png",
    "data/truncated.jpg",
...
registry_urls = {
    key: f"{_GITLAB_DATA_BASE_URL}/{key.rsplit('/', 1)[-1]}" for key in _CDN_HOSTED_KEYS
}
